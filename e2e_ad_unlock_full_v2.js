...
function apiPost(p, body, token) {
  return new Promise((res, rej) => {
    ...
    const r = https.request(
      { hostname: "ccfu.ccwu.cc", path: p, method: "POST", headers: hdrs },
...
function apiGet(p, token) {
  return new Promise((res, rej) => {
    ...
    if (token) hdrs["Authorization"] = "Bearer " + token;
    const r = https.request(
      { hostname: "ccfu.ccwu.cc", path: p, method: "GET", headers: hdrs },
...
function apiAdminLogin() {
  return new Promise((res, rej) => {
    ...
    const r = https.request(
      { hostname: "ccfu.ccwu.cc", path: "/api/admin/login", method: "POST",
