...
(async () => {
  ...
  await page.screenshot({ path: 'test_output/report_jinjie_final.png', fullPage: true });
  console.log('Screenshot saved');
  
  console.log('\n=== Changing tier2_btn_color to #FF4444 ===');
  ...
  await page.screenshot({ path: 'test_output/btn_color_verify.png', fullPage: true });
  console.log('Screenshot saved');
